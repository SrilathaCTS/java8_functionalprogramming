...
public class DatesExp {
	 ...
	 public static void main(String[] args) {
		 ...
		 System.out.println(ZoneId.getAvailableZoneIds());//zone ids
/**
 ...
 *   Australia/Hobart, Europe/London, America/Belize, America/Panama, Asia/Chungking, America/Managua, America/Indiana/Petersburg, 
 *   Asia/Yerevan, Europe/Brussels, GMT, Europe/Warsaw, America/Chicago, Asia/Kashgar, Chile/Continental, Pacific/Yap, CET, Etc/GMT-1, 
 *   Etc/GMT-0, Europe/Jersey, America/Tegucigalpa, Etc/GMT-5, Europe/Istanbul, America/Eirunepe, Etc/GMT-4, America/Miquelon, Etc/GMT-3,
 ...
 */
		...
		System.out.println(dt);
		 ...
		 LocalDateTime dt2 = LocalDateTime.now( ZoneId.of("America/Santiago")) ;
		 System.out.println(dt2);
		 
		 System.out.println(LocalDateTime.now( ZoneId.of("Europe/Athens")));
		 

		 System.out.println(LocalDateTime.now( ZoneId.of("Canada/Yukon")));
		 
		//System.out.println(id.getAvailableZoneIds());//zone ids
		 ...
		 LocalDateTime ldt =  LocalDateTime.of(2014, Month.JANUARY, 1 ,10,30,50); // prepares the date
		 System.out.println(ldt);
		 
		 System.out.println(ZoneId.getAvailableZoneIds().stream()
					.map(zone -> LocalDateTime.now(ZoneId.of(zone)))
